    ...
    <hr>
        <div class="row justify-content-center d-flex align-items-center">
            ...
            <div class="col-md-4 text-center">
                <img src="{{ asset('img/authentication.svg') }}" alt="Recuperar senha" class="img-fluid img-svg" style="max-width: 100%;">
            </div>
            <!-- HR vertical -->
            ...
            <div class="col-md-6">
                <form method="POST" action="{{ route('password.update') }}" class="p-4 shadow rounded">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="Digite seu e-mail" required value="{{ $email }}">
                        @error('email')
